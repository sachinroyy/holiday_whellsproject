...
import React, { useState } from "react";
import freeconsult from "../assets/formnew.gif";
...
const BookingForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const scriptURL = "https://script.google.com/macros/s/AKfycbyWKDSbNnizg6xyABMm7W8lnVdBHZ5Do1h9zzoiuuqyu-kcC49hwLKWZn2y64auuHmf/exec";
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <textarea
                  ...
                  maxLength={500}
                  className="mt-1 block w-full rounded-md border-2 border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                  placeholder="Write your query here (max 500 characters)"
                ></textarea>
              </div>
